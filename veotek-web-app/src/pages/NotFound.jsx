...
const whyChoose = [
  {
    ...
    desc: "Structured code, reusable components, and scalable architecture.",
  },
  {
    icon: ShieldCheck,
    title: "Secure Systems",
    desc: "Security-focused implementation for modern business applications.",
  },
  {
    icon: Sparkles,
    title: "Premium Experience",
    desc: "Modern UI, smooth interactions, and polished user experiences.",
  },
];
  ...
  return (
    <StaggerItem>
      <motion.article
        ...
        className={`relative flex h-full flex-col overflow-hidden rounded-[30px] border p-6 backdrop-blur-2xl sm:rounded-[36px] sm:p-8 ${
          plan.popular
            ? "border-cyan-400/50 bg-cyan-500/[0.08] shadow-[0_24px_90px_rgba(34,211,238,0.14)]"
            : "border-white/10 bg-[#07111f]/75"
        }`}
      >
        <div className="pointer-events-none absolute right-0 top-0 h-52 w-52 rounded-full bg-cyan-500/10 blur-[100px]" />
        ...
        <div className="relative z-10 flex h-full flex-col">
          <div className="flex min-h-8 flex-wrap items-start justify-between gap-3">
            ...
            {plan.badge && (
              <span
                className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-[9px] font-bold uppercase tracking-[0.12em] ${
                  plan.popular
          ...
          <Link
            ...
            className={`mt-9 inline-flex min-h-14 items-center justify-center gap-2 rounded-2xl px-5 py-3 text-center text-sm font-bold transition duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 focus-visible:ring-offset-2 focus-visible:ring-offset-[#07111f] ${
              plan.popular
                ? "bg-cyan-400 text-[#020617] hover:bg-cyan-300"
    ...
    <MainLayout>
      <main>
        ...
        {packages.length > 0 && (
          <section className="pb-20 sm:pb-24">
            <Container className="max-w-[1600px]">
              ...
              <Stagger className="mt-12 grid items-stretch gap-6 lg:mt-14 lg:grid-cols-3 lg:gap-7">
                {packages.map((plan) => (
                  <PricingCard
          ...
          <section className="pb-20 sm:pb-24">
            <Container className="max-w-[1600px]">
              <SectionHeading
                ...
                description="These services can be added to your selected package and will be quoted separately according to the required scope."
              />

              <Stagger className="mt-10 grid gap-4 sm:mt-12 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {additionalServices.map((item) => (
                  <StaggerItem key={item}>
                    <div className="flex h-full items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.035] px-5 py-4">
                      <Check
                        size={16}
                        className="flex-shrink-0 text-cyan-400"
                        aria-hidden="true"
              ...
              <Reveal>
                <div className="mt-10 flex flex-col items-start justify-between gap-6 rounded-[28px] border border-white/10 bg-[#07111f]/70 p-6 backdrop-blur-xl sm:flex-row sm:items-center sm:rounded-[30px] sm:p-7">
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-7 text-slate-400">
                      Tell us what you need and we will prepare a tailored
                      quotation.
                    </p>
                  </div>
                  ...
                  <Link
                    ...
                    className="inline-flex min-h-12 w-full flex-shrink-0 items-center justify-center gap-2 rounded-xl bg-cyan-400 px-6 py-3 text-sm font-bold text-[#020617] transition hover:bg-cyan-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-200 focus-visible:ring-offset-2 focus-visible:ring-offset-[#07111f] sm:w-auto"
                  >
        ...
        <section className="pb-20 sm:pb-24">
          <Container className="max-w-[1600px]">
            <SectionHeading
              eyebrow="Why Choose VeoTek"
              title="Built With A Business-First Approach"
            />
                ...
                return (
                  <StaggerItem key={item.title}>
                    ...
                    >
                      ...
                      <div className="relative z-10 flex h-16 w-16 items-center justify-center rounded-[22px] border border-cyan-400/20 bg-cyan-500/10 text-cyan-400 sm:rounded-[24px]">
                        <Icon size={26} aria-hidden="true" />
                      </div>

                      <h3 className="relative z-10 mt-7 text-xl font-black text-white sm:mt-8 sm:text-2xl">
                        {item.title}
                      </h3>
